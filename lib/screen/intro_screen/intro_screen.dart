...
class _IntroScreenState extends BaseScreenState<IntroScreen, IntroScreenStore> {
  ...
  Widget _buildBody() {
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          title: S.of(context).bigCommunity,
          body: S.of(context).bodyCommunity,
          image: _buildImage(Images.imageIntro1),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: S.of(context).remoteControl,
          body: S.of(context).bodyRemoteControl,
          image: _buildImage(Images.imageIntro2),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: S.of(context).friendlyLayout,
          body: S.of(context).bodyFriendlyLayout,
          image: _buildImage(Images.imageIntro3),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: S.of(context).taskManager,
          body: S.of(context).bodyTaskManager,
      ...
      skip: S.of(context).skip.t2R(color: AppColors.primary),
      next: const Icon(Icons.arrow_forward, color: AppColors.primary),
      done: S.of(context).done.t2R(color: AppColors.primary),
